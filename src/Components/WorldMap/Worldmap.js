...
const Worldmap = () => {
  ...
  const changeshowname = (country, code3) => {
    setContent(country);
    for(let i=0; i<249; i++) {
      if(countryListAllIsoData[i].code3===code3) {
        setCode(countryListAllIsoData[i].code)
      }
    }
  };
      ...
      <Popover.Body style={{
        ...
        color: "#222222"
            ...
            <ReactCountryFlag
                ...
                title={code}
                className="flag"
            />  <span id="country-code">({code})</span>
      </Popover.Body>
    </Popover>
  );
  ...
  const fillColorMap = {
    ...
    Angola: "#c2fa73",
    Albania: "#d773f0",
    "United Arab Emirates": "#FFC759",
    Argentina: "#ab8678",
    Armenia: "#FFC759",
    Antarctica: "#FFFCF9",
    "French Southern and Antarctic Lands": "#FFC759",
    Australia: "#E9DF00",
    Austria: "#e36baa",
    Azerbaijan: "#FAF2A1",
    Burundi: "#FAF2A1",
    ...
    Bhutan: "#f0c846",
    Botswana: "#5edb3b",
    "Central African Republic": "#d1e391",
    Canada: "#FF7B9C",
    Switzerland: "#d65c9c",
    Chile: "#c48972",
    China: "#acde4e",
    "Ivory Coast": "#FF8200",
    Cameroon: "#f08f5b",
    "Democratic Republic of the Congo": "#b3e077",
    "Republic of the Congo": "#e3cd91",
    Colombia: "#bfb0b0",
    "Costa Rica": "#cf8080",
    Cuba: "#f51d3a",
    "Northern Cyprus": "#F6F740",
    Cyprus: "#F6F740",
    "Czech Republic": "#e899ac",
    Germany: "#fa707e",
    Djibouti: "#F7B801",
    Denmark: "#fc9492",
    "Dominican Republic": "#F7B801",
    Algeria: "#fab95f",
    Ecuador: "#f06d3a",
    Egypt: "#cfe85a",
    Eritrea: "#F7B801",
    ...
    Finland: "#f2ce99",
    Fiji: "#f7ed11",
    "Falkland Islands": "#f06d3a",
    France: "#f55b6a",
    Gabon: "#ebbf8a",
    "United Kingdom": "#f76b68",
    Georgia: "#DCED31",
    Ghana: "#f56d18",
    Guinea: "#f0a851",
    Gambia: "#fa9811",
    "Guinea Bissau": "#f7b14f",
    "Equatorial Guinea": "#f0a851",
    Greece: "#d63aa9",
    Greenland: "#f56c7e",
    Guatemala: "#fa465e",
    "French Guiana": "#d6b9ae",
    Guyana: "#f2c7b6",
    Honduras: "#FF0035",
    Croatia: "#e359c3",
    Haiti: "#ebbf96",
    ...
    Russia: "#DDF2EB",
    Rwanda: "#EEF36A",
    "Western Sahara": "#f57445",
    "Saudi Arabia": "#EEF36A",
    Sudan: "#dcfa4d",
    "South Sudan": "#C2E812",
    Senegal: "#f55c20",
    "Solomon Islands": "#EEF36A",
    "Sierra Leone": "#f7b845",
    "El Salvador": "#d65858",
    Somaliland: "#69DC9E",
    Somalia: "#69DC9E",
    "Republic of Serbia": "#e07bc9",
    Suriname: "#f7b9a1",
    Slovakia: "#e099a9",
    Slovenia: "#c254de",
    Sweden: "#f2ae99",
    ...
    Turkmenistan: "#40de88",
    "East Timor": "#98CE00",
    "Trinidad and Tobago": "#CBBAED",
    Tunisia: "#98CE00",
    Turkey: "#dce8a2",
    Taiwan: "#98CE00",
    "United Republic of Tanzania": "#acfa1b",
    Uganda: "#98CE00",
    Ukraine: "#d8d1ed",
    Uruguay: "#d67a56",
    "United States of America": "#FB6376",
    Uzbekistan: "#69DC9E",
    Venezuela: "#F9B9B7",
    Vietnam: "#b9eb2f",
    Vanuatu: "#F9B9B7",
